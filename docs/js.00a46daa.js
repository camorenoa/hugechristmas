...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/data.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js"}],"js/posionator.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.positionator = positionator;

function positionator(santas) {
  var wrapper = document.querySelector(".wrapper");
  var h = document.querySelector(".big");
  var santaHeight = 50;
  var hWidth = h.clientWidth;
  ...
  for (var i = 0; i < santas.length; i++) {
    var randomX = Math.floor(Math.random() * hWidth) + 1;
    var randomY = Math.floor(Math.random() * hHeight) + 1;
    ...
    while (pixelData[0] !== 236) {
      ...
      pixelData = canvas.getContext("2d").getImageData(randomX, randomY, 1, 1).data;
    }
    ...
    santa.style = "left:".concat(randomX, "px;top:").concat(randomY - santaHeight, "px;cursor:pointer;");
...
var _posionator = require("./posionator");
...
function () {
  ...
  _createClass(HugeChristmas, [{
    ...
    value: function init() {
      ...
      var promiseSantas = new Promise(function (resolve, reject) {
        resolve(_this.data.readData());
      });
      promiseSantas.then(function (santas) {
        _this.santas = santas;
        setTimeout(function () {
          _this.loadSantas(_this.santas);
        }, 1000);
      });
    }
  }, {
    key: "loadSantas",
    value: function loadSantas(santas) {
      (0, _posionator.positionator)(santas);
      this.santaEvent();
    }
  }, {
    key: "santaEvent",
    value: function santaEvent() {
      var santasDom = document.querySelectorAll('.santa-random');
      var scope = this;
      ...
      try {
        for (var _iterator = santasDom[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var node = _step.value;
          node.addEventListener('click', function (e) {
            scope.createWindow(e, _objectSpread({}, e.target.dataset));
          });
        }
      } catch (err) {
    ...
    key: "createWindow",
    value: function createWindow(e, data) {
      var messageContainer = document.querySelector('.purpose-data');
      var messageOffice = document.querySelector('.purpose-office');
      var messageText = document.querySelector('.purpose-text');
      var messageName = document.querySelector('.purpose-name');
    ...
    value: function listeners() {
      ...
      var closeWindow = document.querySelector('.purpose-data .close');
      var messageContainer = document.querySelector('.purpose-data');
      var closeFormButton = document.querySelector('.form-container .close');
...
exports.default = _default;
},{"./data":"js/data.js","./posionator":"js/posionator.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
